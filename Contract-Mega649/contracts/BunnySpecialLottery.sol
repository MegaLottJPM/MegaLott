...
contract PancakeProfile is AccessControl, ERC721Holder {
    ...
    function createProfile(
        ...
        lottoToken.safeTransferFrom(_msgSender(), address(this), numberCakeToRegister);
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        lottoToken.safeTransferFrom(_msgSender(), address(this), numberCakeToUpdate);
    ...
    function reactivateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        lottoToken.safeTransferFrom(_msgSender(), address(this), numberCakeToReactivate);
