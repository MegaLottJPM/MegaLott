...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public freeSwapLottery;
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == freeSwapLottery, "Only freeSwapLottery");
    ...
    /**
     * @notice Set the address for the freeSwapLottery
     * @param _freeSwapLottery: address of the JpmSwap lottery
     */
    function setLotteryAddress(address _freeSwapLottery) external onlyOwner {
        freeSwapLottery = _freeSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IFreeLottery(freeSwapLottery).viewCurrentLotteryId();
    }
}