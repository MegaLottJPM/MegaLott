...
// File: lottery/contracts/interfaces/IJpmSwapLottery.sol

pragma solidity >=0.6.0;

interface IJpmSwapLottery {
    /**
...
contract JpmProfile is AccessControl, ERC721Holder {
    ...
    function createProfile(
        ...
        jpmToken.safeTransferFrom(_msgSender(), address(this), numberJpmToRegister);
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        jpmToken.safeTransferFrom(_msgSender(), address(this), numberJpmToUpdate);
    ...
    function reactivateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        jpmToken.safeTransferFrom(_msgSender(), address(this), numberJpmToReactivate);
    ...
    function claimFee(uint256 _amount) external onlyOwner {
        jpmToken.safeTransfer(_msgSender(), _amount);
    }
...
contract BunnySpecialLottery is Ownable {
    ...
    IJpmSwapLottery public jpmSwapLottery;
    ...
    constructor(
        address _jpmSwapLotteryAddress,
        ...
        JpmSwapLottery = IJpmSwapLottery(_jpmSwapLotteryAddress);
    ...
    function _canClaim(
        ...
        if (_bunnyId == nftId1) {
            uint256 size;
            (, , , size) = jpmSwapLottery.viewUserInfoForLotteryId(_userAddress, _lotteryId, 0, 1);
            return size > 0;
        }
        if (_bunnyId == nftId2) {
            ...
            (, , ticketStatuses, size) = jpmSwapLottery.viewUserInfoForLotteryId(
                _userAddress,
                _lotteryId,
                _cursor,
                1
